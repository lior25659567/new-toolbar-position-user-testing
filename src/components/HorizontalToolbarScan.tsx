...
export function UpperJawIcon({ isActive }: { isActive: boolean }) {
  ...
  return (
    <svg width="20" height="20" viewBox="0 0 28 28" fill="none">
      <path d="M5 21C5 21 5 10 14 10C23 10 23 21 23 21" stroke={c} strokeWidth="1" vectorEffect="non-scaling-stroke" strokeWidth={1.6} strokeLinecap="round" fill="none" />
      <path
        ...
        stroke={c} strokeWidth="1" vectorEffect="non-scaling-stroke"
        strokeWidth={1.1}
        strokeLinecap="round"
        fill="none"
      />
...
export function LowerJawIcon({ isActive }: { isActive: boolean }) {
  ...
  return (
    <svg width="20" height="20" viewBox="0 0 28 28" fill="none">
      <path d="M5 7C5 7 5 18 14 18C23 18 23 7 23 7" stroke={c} strokeWidth="1" vectorEffect="non-scaling-stroke" strokeWidth={1.6} strokeLinecap="round" fill="none" />
      <path
...
export function BothJawsIcon({ isActive }: { isActive: boolean }) {
  ...
  return (
    <svg width="20" height="20" viewBox="0 0 28 28" fill="none">
      <path d="M6 15C6 15 6 6 14 6C22 6 22 15 22 15" stroke={c} strokeWidth="1" vectorEffect="non-scaling-stroke" strokeWidth={1.6} strokeLinecap="round" fill="none" />
      <path
        ...
        fill="none"
      />
      <path d="M6 13C6 13 6 22 14 22C22 22 22 13 22 13" stroke={c} strokeWidth="1" vectorEffect="non-scaling-stroke" strokeWidth={1.6} strokeLinecap="round" fill="none" />
      <path
