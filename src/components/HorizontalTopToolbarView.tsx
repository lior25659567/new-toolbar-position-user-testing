  ...
  return (
    <div className="relative shrink-0 size-[40px] flex items-center justify-center" data-name="Mono chomr new">
      <svg width="28" height="28" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
          <clipPath id="clip0_monochrome_htopview">
...
export function HorizontalTopToolbarView({
  ...
  // Best-practice icon-only toolbar (Apple HIG + Material 3 + WCAG 2.5.5):
  //   button 44×44, icon 24px, 4px gap between buttons, 8px padding on container.
  ...
  return (
    <div
      className={`bg-[var(--ads-background-subtle-01)] flex items-stretch relative rounded-[8px] font-['Roboto'] ${
        dense ? "gap-[4px] p-[4px]" : "flex-1 gap-[8px] p-[6px]"
      }`}
