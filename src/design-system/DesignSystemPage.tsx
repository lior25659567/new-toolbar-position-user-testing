      ...
      <div style={{ marginBottom: space[10] }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: space[3] }}>
          ...
          <StateCell label="Toolbar / Hover" hint="Mouse over" tokens={[{ name: "bg: background-subtle-02" }]}>
            <SecondaryButton variant="toolbar" data-force="hover">Hover me</SecondaryButton>
          </StateCell>
          <StateCell label="Toolbar / Active" hint="Toggled on" tokens={[{ name: "bg: background-highlight-blue" }]}>
            <SecondaryButton variant="toolbar" selected>Active</SecondaryButton>
          </StateCell>
        </div>
      </div>
      ...
      <div style={{ marginBottom: space[10] }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: space[3] }}>
          ...
          <StateCell label="Hover" tokens={[{ name: "color.dangerHover" }]}>
            <WarningButton data-force="hover">Hover me</WarningButton>
          </StateCell>
          <StateCell label="Pressed" tokens={[{ name: "color.dangerPressed" }]}>
            <WarningButton data-force="pressed">Press me</WarningButton>
          </StateCell>
          <StateCell label="Focused" tokens={[{ name: "outline: 2px color.primary" }]}>
            <WarningButton data-force="focus">Focus me</WarningButton>
          </StateCell>
          <StateCell label="Disabled" tokens={[{ name: "opacity: 0.5" }]}>
    ...
    <>
      ...
      <div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: space[3] }}>
          ...
          <StateCell label="Hover" hint="Mouse over"><LinkButton data-force="hover">Hover me</LinkButton></StateCell>
          <StateCell label="Pressed" hint="Click & hold"><LinkButton data-force="pressed">Press me</LinkButton></StateCell>
          <StateCell label="Focused" hint="Tab to focus"><LinkButton data-force="focus">Focus me</LinkButton></StateCell>
    ...
    <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: space[6], maxWidth: 720 }}>
        ...
        <div>
          ...
          <Combobox label="Color" options={COMBOBOX_OPTIONS} forceFocus placeholder="Focused" fullWidth />
        </div>
      </div>
      <div style={{ marginTop: space[8] }}>
        <VariantLabel>Open (menu shown statically)</VariantLabel>
        <div style={{ maxWidth: 260, minHeight: 260 }}>
          <Combobox label="Color" options={COMBOBOX_OPTIONS} defaultOpen defaultValue="indigo" fullWidth />
        </div>
      </div>
    </>
  );
  ...
  return (
    <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: space[8], maxWidth: 720 }}>
        ...
        <div>
          <VariantLabel>Handle / Hover</VariantLabel>
          <Slider label="Opacity" value={60} onChange={() => {}} forceState="hover" formatValue={(v) => `${v}%`} />
        </div>
        <div>
          <VariantLabel>Handle / Active</VariantLabel>
          <Slider label="Opacity" value={60} onChange={() => {}} forceState="active" formatValue={(v) => `${v}%`} />
        </div>
        <div>
          <VariantLabel>Handle / Focused</VariantLabel>
          <Slider label="Opacity" value={60} onChange={() => {}} forceState="focus" formatValue={(v) => `${v}%`} />
        </div>
      </div>
    </>
  );
              ...
              <div style={{ marginBottom: space[8] }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: space[3] }}>
                  ...
                  <StateCell label="Hover" hint="Mouse over" tokens={[{ name: "color.neutral100" }]}>
                    <IconButton aria-label="Close" data-force="hover"><svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><path d="M10.5 3.5L3.5 10.5M3.5 3.5l7 7" /></svg></IconButton>
                  </StateCell>
                  <StateCell label="Pressed" hint="Click & hold" tokens={[{ name: "color.bgActive" }, { name: "scale(0.94)" }]}>
                    <IconButton aria-label="Close" data-force="pressed"><svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><path d="M10.5 3.5L3.5 10.5M3.5 3.5l7 7" /></svg></IconButton>
                  </StateCell>
                  <StateCell label="Focused" hint="Tab to focus" tokens={[{ name: "outline: focus-ring" }]}>
                    <IconButton aria-label="Close" data-force="focus"><svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><path d="M10.5 3.5L3.5 10.5M3.5 3.5l7 7" /></svg></IconButton>
                  </StateCell>
                  <StateCell label="Disabled" tokens={[{ name: "opacity: 0.5" }]}>
            ...
            <>
              ...
              <div style={{ marginBottom: space[8] }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: space[3] }}>
                  ...
                  <StateCell label="Toggle / Unselected / Hover" tokens={[{ name: "bg: track-off hover (--ds-toggle-off-hover)" }]}><Toggle forceState="hover" /></StateCell>
                  <StateCell label="Toggle / Selected / Hover" tokens={[{ name: "bg: background-interactive-hover" }]}><Toggle defaultChecked forceState="hover" /></StateCell>
                  <StateCell label="Toggle / Unselected / Pressed" tokens={[{ name: "bg: track-off active (--ds-toggle-off-active)" }]}><Toggle forceState="pressed" /></StateCell>
                  <StateCell label="Toggle / Selected / Pressed" tokens={[{ name: "bg: background-interactive-active" }]}><Toggle defaultChecked forceState="pressed" /></StateCell>
                  <StateCell label="Toggle / Unselected / Focused" tokens={[{ name: "border: color.primary" }]}><Toggle forceState="focus" /></StateCell>
                  <StateCell label="Toggle / Selected / Focused" tokens={[{ name: "border: color.primary" }]}><Toggle defaultChecked forceState="focus" /></StateCell>
            ...
            <>
              ...
              <div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: space[3] }}>
                  ...
                  <StateCell label="Checkbox / Unchecked / Hover" tokens={[{ name: "color.borderHover" }, { name: "color.bgHover" }]}><Checkbox size={20} label="Option A" forceState="hover" /></StateCell>
                  <StateCell label="Checkbox / Checked / Hover" tokens={[{ name: "color.primaryHover" }]}><Checkbox size={20} checked label="Option A" onChange={() => {}} forceState="hover" /></StateCell>
                  <StateCell label="Checkbox / Focused" tokens={[{ name: "border: color.primary" }]}><Checkbox size={20} label="Option A" forceState="focus" /></StateCell>
                  <StateCell label="Checkbox / Checked / Focused" tokens={[{ name: "border: color.primary" }]}><Checkbox size={20} checked label="Option A" onChange={() => {}} forceState="focus" /></StateCell>
            ...
            <>
              ...
              <div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: space[3] }}>
                  ...
                  <StateCell label="Radio / Hover" tokens={[{ name: "color.borderHover" }, { name: "color.bgHover" }]}>
                    <RadioGroup name="radio-s4"><RadioItem value="a" size={20} label="Option A" forceState="hover" /><RadioItem value="b" size={20} label="Option B" /></RadioGroup>
                  </StateCell>
                  <StateCell label="Radio / Selected / Hover" tokens={[{ name: "color.primaryHover" }]}>
                    <RadioGroup name="radio-s5" defaultValue="a"><RadioItem value="a" size={20} label="Option A" forceState="hover" /><RadioItem value="b" size={20} label="Option B" /></RadioGroup>
                  </StateCell>
                  <StateCell label="Radio / Focused" tokens={[{ name: "border: color.primary" }]}>
                    <RadioGroup name="radio-s6"><RadioItem value="a" size={20} label="Option A" forceState="focus" /><RadioItem value="b" size={20} label="Option B" /></RadioGroup>
                  </StateCell>
            ...
            <>
              ...
              <div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: space[5] }}>
                  ...
                  <div><VariantLabel>Input / Focused</VariantLabel><TextInput label="Label" placeholder="Focused" helper="Primary border + focus ring" forceState="focus" /></div>
                  ...
                  <div><VariantLabel>Input / Error / Focused</VariantLabel><TextInput label="Label" defaultValue="Invalid value" error="This field is required" forceState="focus" /></div>
          ...
          {activeId === "text-area" && (
            <>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: space[5] }}>
                ...
                <div><VariantLabel>Text Area / Focused</VariantLabel><TextArea label="Label" placeholder="Focused" helper="Primary border + focus ring" forceState="focus" /></div>
            ...
            <>
              ...
              <div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: space[3] }}>
                  ...
                  <StateCell label="Tab / Hover" tokens={[{ name: "color.borderHover" }]}><Tabs items={[{ id: "a", label: "Tab", forceState: "hover" }]} defaultActiveId="" /></StateCell>
                  <StateCell label="Tab / Focused" tokens={[{ name: "border: color.primary" }]}><Tabs items={[{ id: "a", label: "Tab", forceState: "focus" }]} defaultActiveId="" /></StateCell>
          ...
          {activeId === "number-input" && (
            <>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: space[5] }}>
                ...
                <div><VariantLabel>Number Input / Focused</VariantLabel><NumberInput label="Quantity" defaultValue={5} helper="Primary border + focus ring" forceFocus /></div>
          ...
          {activeId === "search-input" && (
            <>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: space[5] }}>
                ...
                <div><VariantLabel>Search / Focused</VariantLabel><SearchInput placeholder="Focused" forceFocus /></div>
          ...
          {activeId === "dropdown-list" && (
            <>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: space[5] }}>
                ...
                <div><VariantLabel>Dropdown / Focused</VariantLabel><DropdownList label="Country" placeholder="Focused" forceFocus options={[{ value: "us", label: "United States" }, { value: "uk", label: "United Kingdom" }]} /></div>
              ...
              <div style={{ marginTop: space[8] }}>
                <VariantLabel>Dropdown / Open (menu shown statically)</VariantLabel>
                <div style={{ maxWidth: 280, minHeight: 260 }}>
                  <DropdownList label="Country" defaultOpen defaultValue="il" options={[{ value: "us", label: "United States" }, { value: "uk", label: "United Kingdom" }, { value: "il", label: "Israel" }, { value: "de", label: "Germany" }]} />
                </div>
              </div>
            </>
          )}
          ...
          {activeId === "date-picker" && (
            <>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: space[5] }}>
                ...
                <div><VariantLabel>Date Picker / Focused</VariantLabel><DatePicker label="Start Date" helper="Primary border + focus ring" forceFocus /></div>
              ...
              <div style={{ marginTop: space[8] }}>
                <VariantLabel>Date Picker / Open (calendar shown statically)</VariantLabel>
                <div style={{ maxWidth: 260, minHeight: 380 }}>
                  <DatePicker label="Appointment" defaultOpen defaultValue="2026-06-15" />
                </div>
              </div>
            </>
          )}
