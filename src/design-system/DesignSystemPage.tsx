    ...
    <>
      ...
      <div style={{ marginBottom: space[10] }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: space[3] }}>
          ...
          <StateCell label="Hover" tokens={[{ name: "color.bgHover" }, { name: "color.borderStrong" }]}>
            <SecondaryButton>Hover me</SecondaryButton>
          </StateCell>
          <StateCell label="Pressed" tokens={[{ name: "color.bgActive" }]}>
            <SecondaryButton>Press me</SecondaryButton>
          </StateCell>
          <StateCell label="Focused" tokens={[{ name: "border: color.primary" }]}>
    ...
    <>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: space[6], marginBottom: space[8] }}>
        <div>
          ...
          <div style={{ background: "#f5f5f5", padding: space[4], borderRadius: radius.md, display: "inline-block" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: space[3] }}>
          <StateCell label="Default" tokens={[{ name: "bg", value: "transparent" }, { name: "icon", value: "#5E646E" }]}>
            <span style={{ fontSize: font.size.xs, color: color.textSubtle }}>No interaction</span>
          </StateCell>
          <StateCell label="Hover" tokens={[{ name: "bg", value: "#f5f5f5" }, { name: "icon", value: "#008EC2" }]}>
            <span style={{ fontSize: font.size.xs, color: color.textSubtle }}>Mouse over button</span>
          </StateCell>
          <StateCell label="Active" tokens={[{ name: "bg", value: "#E0F2FE" }, { name: "icon", value: "#008EC2" }]}>
  ...
  return (
    <>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: space[3] }}>
        ...
        <StateCell
          label="Current"
          tokens={[{ name: "bg", value: "#009ACE" }, { name: "hover", value: "#0088B8" }, { name: "text", value: "white" }]}
        >
          ...
          {activeId === "toggle" && (
            <>
              ...
              <div style={{ marginBottom: space[8] }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: space[3] }}>
                  <StateCell label="Toggle / Unselected / Default" tokens={[{ name: "bg: #DFDFDF" }]}><Toggle /></StateCell>
                  <StateCell label="Toggle / Selected / Default" tokens={[{ name: "color.primary" }]}><Toggle defaultChecked /></StateCell>
                  <StateCell label="Toggle / Unselected / Hover" hint="Hover to see" tokens={[{ name: "bg: #D2D2D2" }]}><Toggle /></StateCell>
                  <StateCell label="Toggle / Selected / Hover" hint="Hover to see" tokens={[{ name: "bg: #008EC2" }]}><Toggle defaultChecked /></StateCell>
