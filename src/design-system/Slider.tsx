...
export interface SliderProps {
  ...
  className?: string;
  /** Documentation-only: force a thumb visual state statically (no interaction). */
...
if (typeof document !== "undefined" && !document.getElementById("ads-slider-style")) {
  ...
  style.textContent = `
    ...
    /* Documentation-only forced thumb states (data-force on the root) mirror the rules above. */
    [data-design-system="slider"][data-force="hover"] .ads-slider-input::-webkit-slider-thumb { transform: scale(1.08); }
    [data-design-system="slider"][data-force="hover"] .ads-slider-input::-moz-range-thumb { transform: scale(1.08); }
    [data-design-system="slider"][data-force="active"] .ads-slider-input::-webkit-slider-thumb { transform: scale(1.15); box-shadow: var(--ds-shadow-md, 0 2px 8px rgba(0,0,0,0.12)); }
    [data-design-system="slider"][data-force="active"] .ads-slider-input::-moz-range-thumb { transform: scale(1.15); box-shadow: var(--ds-shadow-md, 0 2px 8px rgba(0,0,0,0.12)); }
    [data-design-system="slider"][data-force="focus"] .ads-slider-input::-webkit-slider-thumb { box-shadow: 0 0 0 4px var(--ds-color-primary-ring, rgba(59, 126, 190, 0.25)); }
    [data-design-system="slider"][data-force="focus"] .ads-slider-input::-moz-range-thumb { box-shadow: 0 0 0 4px var(--ds-color-primary-ring, rgba(59, 126, 190, 0.25)); }
