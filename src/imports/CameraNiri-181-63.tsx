import svgPaths from "./svg-zq08b3igaa";
...
function Group4() {
  return (
    <div className="absolute bottom-0 contents left-0 right-0 top-[0.16%]">
      <div className="absolute bottom-0 left-0 right-0 rounded-[4px] top-[0.16%]" data-name="Screenshot 2022-11-09 at 13.09 2">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[4px]">
