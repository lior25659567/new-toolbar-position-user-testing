import svgPaths from "./svg-p46vrdf8pl";
...
function MonochromeButton() {
  return (
    <div className="absolute left-0 rounded-[10px] size-[60px] top-0" data-name="MonochromeButton">
      <Container />
      <MonoChomrNew />
    </div>
  );
...
function FeedbackButton() {
  return (
    <div className="absolute left-0 rounded-[10px] size-[60px] top-0" data-name="FeedbackButton">
      <Container3 />
      <TrimArea4 />
    </div>
  );
...
function PrepEditButton() {
  return (
    <div className="absolute left-0 rounded-[10px] size-[60px] top-0" data-name="PrepEditButton">
      <Container5 />
      <Frame />
    </div>
  );
