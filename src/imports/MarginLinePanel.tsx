    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '2px' }}>
          ...
          <span style={{ fontSize: '36px', fontWeight: 700, color: '#101828', lineHeight: '40px', letterSpacing: '0.37px', fontFamily: 'Inter, sans-serif' }}>
            11
          </span>
          <span style={{ fontSize: '14px', fontWeight: 400, color: '#6a7282', lineHeight: '20px', fontFamily: 'Inter, sans-serif' }}>
            Upper Jaw
          </span>
        </div>
      ...
      >
        ...
        <div className="flex gap-2">
          ...
          <div style={{ flex: '1 0 0', minWidth: 0 }}>
            <SecondaryButton size={60} fullWidth style={{ flexDirection: 'column', gap: '4px', padding: '8px 4px' }}>
              <ClearIcon />
              <span style={{ fontSize: '16px' }}>Clear</span>
            </SecondaryButton>
          </div>
        </div>
      </div>
