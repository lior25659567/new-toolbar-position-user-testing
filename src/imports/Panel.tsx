    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '2px' }}>
          <span style={{ fontSize: '11px', fontWeight: 500, color: '#6a7282', textTransform: 'uppercase', letterSpacing: '0.3px', fontFamily: 'Inter, sans-serif' }}>
            TOOTH
          </span>
          <span style={{ fontSize: '28px', fontWeight: 700, color: '#101828', lineHeight: '32px', letterSpacing: '0.37px', fontFamily: 'Inter, sans-serif' }}>
            11
          </span>
          <span style={{ fontSize: '12px', fontWeight: 400, color: '#6a7282', lineHeight: '20px', fontFamily: 'Inter, sans-serif' }}>
            Upper Jaw
          </span>
        </div>
