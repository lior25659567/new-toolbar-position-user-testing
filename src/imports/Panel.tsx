...
function DrawIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0, minWidth: '20px', minHeight: '20px' }}>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ height: '56px', padding: '0 16px', borderBottom: '1px solid var(--ads-border-subtle)' }}
      >
        <h2
          style={{
      ...
      >
        <SecondaryButton size={44} style={{ width: '44px', height: '44px', padding: 0 }} aria-label="Previous tooth">
          <ChevronLeftIcon />
        </SecondaryButton>

        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '2px' }}>
          <span style={{ fontSize: '11px', fontWeight: 500, color: 'var(--ads-text-muted)', textTransform: 'uppercase', letterSpacing: '0.04em', fontFamily: 'var(--ads-font-sans)' }}>
            TOOTH
          </span>
        ...
        <SecondaryButton size={44} style={{ width: '44px', height: '44px', padding: 0 }} aria-label="Next tooth">
          <ChevronRightIcon />
        </SecondaryButton>
      </div>
