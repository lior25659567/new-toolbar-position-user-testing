...
function Frame6() {
  return (
    <div className="absolute bottom-0 content-stretch flex font-['Avenir:Roman',sans-serif] items-center justify-between leading-[32px] left-0 not-italic right-[22.08%] text-[16px] text-black top-[49.67%]">
