import svgPaths from "./svg-i7jfufrxp5";
...
function ToolbarTextLabel4() {
  return (
    <div className="bg-[#dff5fc] content-stretch flex items-center relative rounded-[4px] shrink-0" data-name="Toolbar Text label">
      <AohsButton4 />
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="bg-white content-stretch flex flex-col h-full items-center justify-center relative rounded-bl-[12px] rounded-br-[12px] w-[76px]">
...
function Frame8() {
  return (
    <div className="content-stretch flex gap-[8px] items-start justify-center relative shrink-0">
      <Frame9 />
      <div className="flex items-center justify-center relative self-stretch shrink-0 w-[68px]" style={{ "--transform-inner-width": "76", "--transform-inner-height": "76" } as React.CSSProperties}>
